...
export default function Footer() {
  return (
    <footer className="bg-gray-900 border-t border-gray-800 mt-16 relative overflow-hidden">
      ...
      <div className="absolute bottom-6 right-6 opacity-10 pointer-events-none select-none" aria-hidden="true">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-16 h-16">
          <path d="M5.25 4.5l14.25 7.5-14.25 7.5V4.5z" />
        </svg>
      </div>
    </footer>
  );
